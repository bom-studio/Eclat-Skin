...
export const PROGRAMS = [
  {
    ...
    korean: "베이직 케어",
    price: "59,000",
    description: "피부 컨디션을 가볍게 정돈하는 입문 케어",
    effects: ["수분 밸런스", "피부결 정돈", "피부 보호"],
    image: "/images/programs/basic-care.png",
    imageAlt: "베이직 케어 프로그램",
  },
  {
    id: "hydration",
    number: "02",
...
export const FAQS = [
  ...
  },
  {
    ...
    question: "시술 후 주의사항은?",
    answer:
      "시술 당일은 강한 스크럽, 사우나, 음주, 과도한 자외선 노출을 피해주세요. 홈케어 방법은 시술 후 맞춤으로 안내드립니다.",
  },
  {
    id: 6,
